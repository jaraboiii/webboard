    ...
    <>
        ...
        <div className="mb-6 space-y-3">
             <button 
                ...
                type="button"
                className="w-full flex items-center justify-center gap-2 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-medium py-2.5 rounded-lg transition-all"
             >
        ...
        <form action={action} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">ชื่อที่ใช้แสดง</label>
            <input 
              name="name" 
              type="text" 
              required 
          ...
          <button 
            type="submit" 
            disabled={isPending}
            className="w-full bg-black hover:bg-gray-800 text-white font-medium py-2.5 rounded-lg transition-all disabled:opacity-50"
          >
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
           มีบัญชีอยู่แล้ว? <Link href="/login" replace className="text-black font-semibold hover:underline">เข้าสู่ระบบ</Link>
        </div>
    </>
  );
}
