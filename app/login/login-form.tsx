  ...
  return (
    <>
        <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-500 mt-1">ยินดีต้อนรับกลับสู่ Webboard</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
           ยังไม่มีบัญชี? <Link href="/signup" replace className="text-black font-semibold hover:underline">สมัครสมาชิก</Link>
        </div>
    </>
  );
}
